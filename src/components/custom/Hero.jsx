    ...
    <>
      ...
      <div className="w-full bg-gradient-to-b from-white to-gray-50 py-12">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                icon: <FaGlobe className="h-10 w-10 text-orange-500 " />,
              ...
              {
                icon: <FaSuitcase className="h-10 w-10 text-green-500" />,
      ...
      <div className="w-full bg-white py-16">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
          ...
          >
            <Link to="/create-trip">
              <Button className="bg-gradient-to-r from-orange-500 to-amber-500 text-white hover:from-orange-600 hover:to-amber-600 mt-8 mb-0">
